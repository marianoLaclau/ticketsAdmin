...
export const ListTicketsResponse = zod.object({
  ...
  "estado_empleado": zod.union([zod.literal('Activo'),zod.literal('Inactivo'),zod.literal(null)]).nullish().describe('Estado laboral informado; solo se presenta cuando el ticket tiene una empresa asociada'),
