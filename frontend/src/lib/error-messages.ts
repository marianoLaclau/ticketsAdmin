...
function knownBusinessMessage(error: unknown): string | undefined {
  ...
  if (message.includes("contrasen") || message.includes("password")) {
    ...
    if (
      message.includes("principio") ||
      message.includes("comenzar") ||
      message.includes("terminar con espacios")
    ) {
    ...
    if (
      ...
      message.includes("predecible") ||
      message.includes("ejemplo publico")
    ) {
  ...
  if (
    ...
    message.includes("reservado") &&
    message.includes("rol")
  ) {
    return "Ese nombre está reservado para un rol del sistema.";
  }
  if (message.includes("roles del sistema")) {
    if (message.includes("renombrar"))
      return "Los roles del sistema no se pueden renombrar.";
    if (message.includes("permanecer activos"))
      return "Los roles del sistema deben permanecer activos.";
    if (message.includes("eliminar"))
      return "Los roles del sistema no se pueden eliminar.";
  }
  ...
  if (
    message.includes("rol indicado no existe") ||
    message.includes("rol no encontrado")
  ) {
  ...
  if (
    message.includes("ya existe un ticket") ||
  ...
  if (
    ...
    message.includes("ticket no encontrado")
  ) {
