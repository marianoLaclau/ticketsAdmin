...
const ERROR_COPY: Record<number, ErrorCopy> = {
  ...
  409: {
    ...
    message:
      "La información cambió o entra en conflicto con otro registro. Actualizá los datos e intentá nuevamente.",
    icon: AlertTriangle,
  },
  500: {
    title: "Ocurrió un error inesperado",
    message:
      "No pudimos completar la solicitud. Intentá nuevamente en unos instantes.",
    icon: ServerCrash,
  },
  503: {
    title: "Servicio no disponible",
    message:
      "No pudimos conectarnos con el servicio. Revisá la conexión e intentá nuevamente.",
    icon: WifiOff,
  },
};
...
const DEFAULT_ERROR: ErrorCopy = {
  ...
  message:
    "Ocurrió un problema inesperado. Volvé al inicio o intentá nuevamente.",
  icon: AlertTriangle,
};
...
> {
  ...
  override render() {
    if (this.state.hasError) {
      return (
        <ErrorPage status={500} onRetry={() => window.location.reload()} />
      );
    }
