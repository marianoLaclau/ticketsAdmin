...
- un cambio real de `usuarios.role_id` revoca en la misma transacción todas las sesiones de esa cuenta y cierra sus SSE después del commit; reenviar el mismo rol es un no-op para la sesión;
