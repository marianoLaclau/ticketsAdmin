...
| `GET /api/rendimiento/personas`          | Actividad atribuible por usuario, tiempos y cumplimiento del plazo con muestra, carga actual y resoluciones reabiertas; incluye cobertura global y no construye rankings.                                         |
