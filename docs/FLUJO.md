...
- **Cumplimiento del plazo**: porcentaje de resoluciones auditables realizadas antes o exactamente en el plazo que tenían al resolverse. Solo entran las transiciones reales de abierto a final que guardaron `fecha_limite_snapshot`; las resoluciones anteriores a esa auditoría no se estiman con datos actuales.
