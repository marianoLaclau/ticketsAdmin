...
| `GET /api/rendimiento`                   | Estado del módulo ejecutivo. Informa operación parcial: Resumen, Personas y Calidad están operativos; Reiteraciones continúa en preparación.                                                                            |
