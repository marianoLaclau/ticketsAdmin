...
| `GET /rendimiento`                  | Estado contract-first del módulo ejecutivo: devuelve `estado: "operativo_parcial"`; Resumen y Calidad están operativos, mientras Personas y Reiteraciones siguen en preparación. Toda la frontera `/rendimiento` está protegida por `requirePerformanceAccess` y responde con `Cache-Control: private, no-store`.                                                                                                                                                                                                                                                                                                                  | ✅🧭                             |
