...
| `GET /rendimiento/reiteraciones`    | Contactos con al menos dos tickets del conjunto analizado y uno todavía abierto. Usa una clave canónica única DNI → teléfono → email, solo hereda relaciones directas unívocas, evita uniones transitivas, enmascara PII y ordena los grupos por riesgo operativo.                                                                                                                                                                                                                                                                                                                                                                 | ✅🧭                             |
