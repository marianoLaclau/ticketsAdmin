...
| `GET /rendimiento/calidad-datos`    | Cobertura auditable de autoría, fechas de resolución, snapshot del plazo, asignación estructurada, identidad de contacto y fecha límite. Usa una única cohorte visible por `fecha_creacion` y los filtros opcionales de período, empresa, categoría y prioridad.                                                                                                                                                                                                                                                                                                                                                                   | ✅🧭                             |
| `GET /rendimiento/resumen-equipo`   | Resumen real de la misma cohorte: tickets ingresados, fotografía de estados y prioridades, abiertos/finalizados/vencidos, promedio y mediana de resolución con muestra, y cumplimiento del plazo con muestra auditable.                                                                                                                                                                                                                                                                                                                                                                                                            | ✅🧭                             |
...
| `GET /rendimiento/reiteraciones`    | Contactos con al menos dos tickets de la cohorte y uno todavía abierto. Usa una clave canónica única DNI → teléfono → email, solo hereda relaciones directas unívocas, evita uniones transitivas, enmascara PII y ordena los grupos por riesgo operativo.                                                                                                                                                                                                                                                                                                                                                                          | ✅🧭                             |
...
La cohorte contiene tickets operativos —sin cuarentena— según su `fecha_creacion`. El bloque `estado_actual` es una fotografía de esa cohorte al instante `generado_en`, no una reconstrucción histórica. Los tiempos de resolución informan muestra, promedio y mediana únicamente para tickets actualmente finalizados con fechas válidas y duración no negativa.
