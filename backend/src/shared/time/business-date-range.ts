...
/** Normaliza fechas calendario según Buenos Aires, sin depender de la TZ del host. */
export function normalizeBusinessDateQuery(
...
export function isBusinessDateRangeValid(range: BusinessDateRange): boolean {
  return !(
    range.fecha_desde &&
    range.fecha_hasta &&
