...
- **Rendimiento ejecutivo auditable**: SysAdmin y Controller disponen de `/rendimiento` con sus cuatro vistas operativas. **Resumen del equipo** muestra el conjunto analizado visible creado en el período, estado, distribuciones, tiempos y cuatro indicadores explícitos: cumplimiento auditable del SLA, porcentaje del backlog vencido, antigüedad mediana del backlog en horas hábiles y cobertura de asignación estructurada. Cada indicador informa su muestra o denominador y queda sin porcentaje/mediana cuando no existe una muestra válida; no se inventan resultados históricos ni metas de Dirección. **Operadores** presenta actividad atribuible, muestras, carga y reaperturas sin rankings; **Contactos recurrentes** detecta y pagina por riesgo contactos con múltiples tickets y al menos uno abierto mediante una identidad canónica no transitiva y siempre enmascarada; **Calidad de datos** explicita la cobertura de cada medición.
